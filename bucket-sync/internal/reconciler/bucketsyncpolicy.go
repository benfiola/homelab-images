...
func (r *BucketSyncPolicyReconciler) Reconcile(pctx context.Context, request controllerruntime.Request) (controllerruntime.Result, error) {
	...
	sync := &api.BucketSync{
		...
		Spec: api.BucketSyncSpec{
			...
			SourceEncryptionKey:       policy.Spec.SourceEncryptionKey,
			SourceEncryptionSalt:      policy.Spec.SourceEncryptionSalt,
			DestinationEncryptionKey:  policy.Spec.DestinationEncryptionKey,
			DestinationEncryptionSalt: policy.Spec.DestinationEncryptionSalt,
